...
import com.example.greenlight.AdapterClasses.ChatsAdapter
import com.example.greenlight.ModelClasses.Chat
import com.example.greenlight.ModelClasses.Users
import com.example.greenlight.Notifications.*
import com.example.greenlight.Service.APIService
...
class MessageChatActivity : AppCompatActivity() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 438 && resultCode == RESULT_OK && data != null && data.data != null) {
            val progressBar = ProgressDialog(this@MessageChatActivity)
